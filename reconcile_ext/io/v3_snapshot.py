...
def _wall_features(corners: list[Vec3]) -> tuple[float, float, float, float, float] | None:
...
def build_snapshot(
    ...
    for sr in v3_results.get("slanted_roofs", []) or []:
        ...
        azimuth_deg, inclination_deg, ridge_y, eave_y = _slanted_roof_features(plane_t, corners)
