...
def test_closing_fills_thin_gap_between_room_candidates():
    ...
    # Closing rounds the outer corners slightly; area is ~34 m² (32 from
    # candidates + 2 from the filled notch) minus <0.1 m² corner smoothing.
...
def test_building_fp_union_from_room_floor_polygons():
    ...
    # Two rooms of 12 m² sharing an edge → 21 m² total.
...
def test_flood_fill_covers_cross_story_extension():
    ...
    # Full envelope is 24 m²; we should cover it all (candidate + extension).
...
def test_flood_fill_skips_detached_components():
    ...
    # Roughly candidate area; no absorption of the 16 m² outbuilding.
