...
def _index_html_shell(entries: list[dict]) -> str:
    ...
    parts = [
        ...
        ".missing { width: 420px; height: 300px; border: 1px dashed #555; display:inline-block; text-align:center; line-height:300px; color:#666; }",
        "</style></head><body>",
    ...
    for entry in entries:
        ...
        for shot in entry["shots"]:
            ...
            parts.append(
                ...
                f"onerror=\"this.outerHTML='<div class=missing>missing: {fname}</div>'\">"
...
def main() -> int:
    ...
    print(f"Queued {sum(len(e['shots']) for e in todo_entries)} screenshots "
