...
def main() -> int:
    ...
    ap.add_argument("--roof-results", default="reconcile/roof_algorithms_py_results.json", type=Path)
    ...
    for i, building in enumerate(corpus):
        ...
        bldg = None
        try:
            bldg, fp = _load_building_and_scan_footprint(uuid, args.pipeline_dir, scan_cache_root)
