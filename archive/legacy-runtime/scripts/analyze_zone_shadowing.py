...
def main() -> int:
    ...
    ap.add_argument("artifact", type=Path, help="candidate_faces/candidates.json artifact")
    ap.add_argument("--compare", type=Path, default=None, help="optional second artifact to compare")
            ...
            json.dumps(
                {
                    ...
                    **comparison,
                    "delta": {
                        "no_part_zones": comparison["no_part_zones"] - baseline["no_part_zones"],
                        "shadow_zones": comparison["shadow_zones"] - baseline["shadow_zones"],
                        "buildings_with_shadow": comparison["buildings_with_shadow"] - baseline["buildings_with_shadow"],
                    },
                },
                indent=2,
            )
