...
def annotate_split_rows_with_ownership(
    ...
    for row in split_piece_rows:
        ...
        for relation in relations_by_target.get(target_id, []):
            other_target_id = (
                relation.b_target_id if relation.a_target_id == target_id else relation.a_target_id
            )
        ...
        piece_part_ids_all = _parts_for_poly(piece_poly, room_polys_all, room_membership)
        ...
        annotated["local_competitor_target_ids"] = sorted(set(local_competitor_target_ids))
        ...
        annotated["source_part_overlap_fraction"] = round(source_part_overlap_fraction, 6)
