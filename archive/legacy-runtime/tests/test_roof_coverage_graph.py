...
def test_roof_coverage_graph_marks_flat_atom_as_confirmed_sloped_coverage_when_roof_is_above() -> None:
    room_partitions = [
        {
            "room_index": 0,
            "story": 1,
...
def test_roof_coverage_graph_marks_planar_overlap_as_partial_when_roof_plane_is_not_above() -> None:
    room_partitions = [
        {
            "room_index": 0,
            "story": 1,
...
def test_roof_coverage_graph_seeds_subpart_from_surface_room_support_when_best_atom_match_picks_sibling_hypothesis() -> None:
    room_partitions = [
        {
            "room_index": 0,
            "story": 1,
    ...
    subpart_hypotheses = {subpart["roof_hypothesis_id"] for subpart in graph["subparts"]}
