...
def test_find_element_roof_oblique_falls_back_to_roof_results():
    buildings = [{"uuid": "11111111-2222-3333-4444-555555555555", "address": "Testvej 1", "rooms": []}]
    result = find_element(
        buildings,
        "11111111-2222-3333-4444-555555555555::roof-oblique::oblique:0",
            ...
            uuid: [
                {
                    "uuid": uuid,
                    "story": 1,
                    "target_element_id": f"{uuid}::ridge-eave-candidate::plane-group::v2abc",
                    "target_kind": "ridge_eave_plane_group",
                    "piece_id": f"{uuid}::ridge-eave-candidate::plane-group::v2abc#supported:0:0",
                    "piece_role": "supported",
                    "support_score": 0.97,
