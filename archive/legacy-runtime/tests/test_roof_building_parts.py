...
def _graph() -> TopologyGraph:
    return TopologyGraph(
        ...
        nodes=[
            ...
            GraphNode(id="room:r2", type="Room", story=0, bbox_xz=[8.0, 0.0, 12.0, 4.0]),
        ],
        edges=[
            GraphEdge(
                id="adj:r0-r1",
...
def _graph_with_isolated_room() -> TopologyGraph:
    return TopologyGraph(
        ...
        nodes=[
            GraphNode(id="room:r0", type="Room", story=0, bbox_xz=[0.0, 0.0, 4.0, 4.0]),
            GraphNode(id="room:r1", type="Room", story=0, bbox_xz=[4.0, 0.0, 8.0, 4.0]),
            GraphNode(id="room:r2", type="Room", story=0, bbox_xz=[20.0, 0.0, 24.0, 4.0]),
        ],
        edges=[
            GraphEdge(
                id="adj:r0-r1",
...
def test_match_graph_room_prefers_exact_cell_footprint_overlap_over_bbox_centroid() -> None:
    graph = TopologyGraph(
        version="test",
        metadata={},
        nodes=[
            GraphNode(id="room:r0", type="Room", story=0, bbox_xz=[0.0, 0.0, 10.0, 10.0]),
            GraphNode(id="room:r1", type="Room", story=0, bbox_xz=[0.0, 0.0, 10.0, 10.0]),
        ],
        edges=[],
        geometry_index={
            "cell_complex": {
                "cells": [
                    {
                        ...
                        "kind": "room",
                        "source_id": "room:r0",
                        "properties": {"xz_footprint": [[0.0, 0.0], [4.0, 0.0], [4.0, 4.0], [0.0, 4.0]]},
                    },
                    {
                        "id": "cell:r1",
                        "kind": "room",
                        "source_id": "room:r1",
                        "properties": {"xz_footprint": [[4.0, 0.0], [8.0, 0.0], [8.0, 4.0], [4.0, 4.0]]},
                    },
                ]
            }
        },
...
def test_match_graph_room_uses_largest_polygon_from_make_valid_geometry_collection() -> None:
    graph = TopologyGraph(
        version="test",
        metadata={},
        nodes=[
            GraphNode(id="room:r0", type="Room", story=0, bbox_xz=[-6.0, -5.0, -2.0, 2.0]),
            GraphNode(id="room:r1", type="Room", story=0, bbox_xz=[-4.0, -5.0, 6.0, 5.0]),
        ],
        edges=[],
        geometry_index={
            "cell_complex": {
                "cells": [
                    {
                        ...
                        "kind": "room",
                        "source_id": "room:r0",
                        "properties": {"xz_footprint": [[-6.0, -5.0], [-2.0, -5.0], [-2.0, 2.0], [-6.0, 2.0]]},
                    },
                    {
                        "id": "cell:r1",
                        "kind": "room",
                        "source_id": "room:r1",
                        "properties": {"xz_footprint": [[-4.0, -5.0], [6.0, -5.0], [6.0, 5.0], [-4.0, 5.0]]},
                    },
                ]
            }
        },
...
def _hypothesis_graph() -> dict:
    return {
        "nodes": [
            {"id": "roof-hypothesis:oblique:0", "type": "RoofHypothesis", "surface_kind": "oblique", "selected": True},
            {"id": "roof-hypothesis:oblique:1", "type": "RoofHypothesis", "surface_kind": "oblique", "selected": True},
            {
...
def test_building_part_graph_detects_sloped_part_from_room_adjacency_and_oblique_support() -> None:
    exposed_rooms = [
        {"room_index": 0, "graph_room_id": "room:r0", "fp": _rect(0.0, 0.0, 4.0, 4.0), "wallTopY": 3.1, "wallTopMin": 2.0},
        {"room_index": 1, "graph_room_id": "room:r1", "fp": _rect(4.0, 0.0, 8.0, 4.0), "wallTopY": 3.0, "wallTopMin": 2.1},
        {"room_index": 2, "graph_room_id": "room:r2", "fp": _rect(8.0, 0.0, 12.0, 4.0), "wallTopY": 3.1, "wallTopMin": 2.2},
    ]
    ...
    assert any(node["roof_family_guess"] == "gable_or_multi_slope" for node in part_graph["nodes"])
...
def test_building_part_graph_keeps_isolated_supported_room_as_its_own_part() -> None:
    exposed_rooms = [
        {"room_index": 0, "graph_room_id": "room:r0", "fp": _rect(0.0, 0.0, 4.0, 4.0), "wallTopY": 3.1, "wallTopMin": 2.0},
        {"room_index": 1, "graph_room_id": "room:r1", "fp": _rect(4.0, 0.0, 8.0, 4.0), "wallTopY": 3.0, "wallTopMin": 2.1},
        {"room_index": 2, "graph_room_id": "room:r2", "fp": _rect(20.0, 0.0, 24.0, 4.0), "wallTopY": 3.2, "wallTopMin": 2.0},
    ]
    hypothesis_graph = {
        "nodes": [
            {"id": "roof-hypothesis:oblique:0", "type": "RoofHypothesis", "surface_kind": "oblique", "selected": True},
...
def test_building_part_graph_uses_hypothesis_support_and_expands_to_lower_rooms() -> None:
    exposed_rooms = [
        {"room_index": 0, "graph_room_id": "room:r0", "fp": _rect(0.0, 0.0, 4.0, 4.0), "wallTopY": 3.1, "wallTopMin": 2.0, "story": 1},
        {"room_index": 1, "graph_room_id": "room:r1", "fp": _rect(4.0, 0.0, 8.0, 4.0), "wallTopY": 3.0, "wallTopMin": 2.1, "story": 1},
    ]
    bldg = {
        "rooms": [
    ...
    assert part_graph["room_membership"]["room:2"] == part_graph["room_membership"]["room:0"]
