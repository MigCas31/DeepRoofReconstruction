...
def test_roof_envelope_continuation_promotes_flat_only_sloped_room_to_exact_upper_void() -> None:
    exposed_rooms = [
        {
            "room_index": 0,
            "story": 1,
    ...
    room1 = next(room for room in final_partitions["room_partitions"] if room["room_index"] == 1)
...
def test_roof_envelope_continuation_uses_structural_subpart_semantics_before_part_relabel() -> None:
    exposed_rooms = [
        {
            "room_index": 0,
            "story": 1,
