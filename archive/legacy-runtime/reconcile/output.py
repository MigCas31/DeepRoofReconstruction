...
def write_reconciled(
    ...
    data = {
        ...
        "reconciliation": {
            ...
            "median_wall_displacement_m": round(quality_report.median_wall_displacement_m, 2),
            ...
            "walls_with_large_displacement": quality_report.walls_with_large_displacement,
