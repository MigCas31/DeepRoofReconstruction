...
def _group_rooms(entries: list[tuple[float, float, dict]]) -> list[list[tuple[float, float, dict]]]:
    ...
    for entry in entries:
        ...
        spread_ok = fy - min(group_floor_ys) <= FLOOR_ALIGN_TOL_M and group_spread <= FLOOR_ALIGN_TOL_M
