...
# oblique slopes (e.g. RoomPlan-noise tilts of 5–10°). They pollute gable
...
def detect_gable(oblique_surfaces: list[dict[str, Any]]) -> bool:
    ...
    A gable is a pair of opposite-azimuth planes (≈ 180° apart) with similar
    inclinations (within 10°) whose combined area covers ≥ 70 % of the total
