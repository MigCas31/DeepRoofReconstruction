...
from reconcile.roof.roof import Footprint, RoofCluster, RoofPlaneCandidate
...
def build_roof_planes(clusters: list[RoofCluster], footprint: Footprint) -> list[RoofPlaneCandidate]:
    candidates: list[RoofPlaneCandidate] = []
    if not footprint.polygon_xz or polygon_xz_area([[x, 0.0, z] for x, z in footprint.polygon_xz]) <= 0.0:
        return candidates
