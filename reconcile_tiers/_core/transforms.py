...
def corners_to_world(corners: Sequence[Sequence[float]], transform: np.ndarray) -> list[list[float]]:
    ...
    for corner in corners:
        ...
        world = matrix @ np.array([float(corner[0]), float(corner[1]), float(corner[2]), 1.0])
