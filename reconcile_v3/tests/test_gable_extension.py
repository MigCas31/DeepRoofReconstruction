...
def test_not_gable_mismatched_inclinations():
    ...
    result = _classify_single_part(
        part,
        roofs=[_make_roof(plane_a, corners_a, "uuid::v3-slanted-roof::a"),
...
def test_gable_along_extend_synthetic():
    ...
    result = _classify_single_part(
        part,
        roofs=[_make_roof(plane_east, corners_e, "uuid::v3-slanted-roof::e"),
...
def test_gable_cross_review_ridge_across_short_axis():
    ...
    result = _classify_single_part(
        part,
        roofs=[_make_roof(plane_n, corners_n, "uuid::v3-slanted-roof::n"),
