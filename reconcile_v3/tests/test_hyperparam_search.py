...
import optimize_reconstruction as opt_mod  # noqa: E402

from reconcile_v3.reconstruction.solver import SolverConfig  # noqa: E402
...
def test_top_trial_written_to_disk(tmp_path: Path) -> None:
    ...
    for t in trials:
        assert set(t.keys()) >= {"trial", "config", "score", "aggregate", "per_building"}
